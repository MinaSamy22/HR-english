...
<div class="content-wrapper" style="background-color: white;">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3>{{ __('E_resignation.submit_resignation') }}</h3>
...
@endif
        ...
        <div class="row">
            <div class="col-12">
                <h3>{{ __('E_resignation.my_resignation_requests') }}</h3>
...
<td>
    ...
    @endif
            ...
            <td>
                @if($resignation->status === 'pending')
                    <form method="POST" action="{{ route('employee.resignation.destroy', $resignation->id) }}" onsubmit="return confirm('{{ __('E_resignation.confirm_delete') }}');">
                        @csrf
                        @method('DELETE')
    ...
    @empty
        <tr>
            <td colspan="5" class="text-center">{{ __('E_resignation.no_requests_submitted') }}</td>
        </tr>
    @endforelse
</tbody>
                </table>
