            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('register_post') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="{{ __('auth.hr_name') }}" name="name" required
                            value="{{ old('name') }}">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="{{ __('auth.email') }}" name="email" required
                            value="{{ old('email') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="form-group position-relative">
                        ...
                        <span class="position-absolute" onclick="togglePassword('confirm_password', 'eyeIcon2')"
                            style="top: 10px; right: 15px; cursor: pointer;">
                    ...
                    <!-- Company Name -->
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="{{ __('auth.company_name') }}" name="company_name"
                    ...
                    <!-- Country -->
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="{{ __('auth.country') }}" name="country" required
                            value="{{ old('country') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <!-- Address -->
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="{{ __('auth.address') }}" name="address" required
                            value="{{ old('address') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
