            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item "><a href="{{ url('admin/administration') }}">{{ __('h_adminstration.breadcrumb_administration') }}</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('administration_update',$getRecord->id) }}"
...
value = old for not rebeating the input  --}}
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">{{ __('h_adminstration.code') }} <span style="color: red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->code }}" name="code"
                                                class="form-control" required placeholder="{{ __('h_adminstration.enter_code') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary float-right">{{ __('h_adminstration.update') }}</button>
                                </div>
                            </form>
