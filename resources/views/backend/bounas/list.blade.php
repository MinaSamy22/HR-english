                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2 col-sm-6">
                                            ...
                                            <input type="text" value="{{ Request()->name }}" name="name"
                                                class="form-control" placeholder="{{ __('h_bounas.name_placeholder') }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3 col-sm-6 d-flex align-items-end">
                                            ...
                                            <a href="{{ url('admin/bounas') }}" class="btn btn-success rounded-pill">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="ml-auto">
                                    <button class="btn btn-danger"
                                        id="deleteSelected">{{ __('h_bounas.delete_selection_btn') }}</button>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @forelse ($getRecord as $value)
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" class="bounasCheckbox"
                                                            value="{{ $value->id }}"></td>
