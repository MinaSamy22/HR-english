                        ...
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" method="post" accept="{{ url('admin/employees/add') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('name') }}" name="name"
                                                class="form-control" required placeholder="{{ __('h_employee.enter_name') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable">{{ __('h_employee.mobile_mac_address') }}</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('macaddress') }}" name="macaddress"
                                                class="form-control" placeholder="{{ __('h_employee.enter_mac_address_optional') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable">{{ __('h_employee.hire_date') }} <span style="color: red;">{{ __('h_employee.required_field') }}</span></label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable" for="attachment">{{ __('h_employee.attachment') }}:</label>
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="manager_id" required>
                                                ...
                                                @foreach ($getManagers as $value_manager)
                                                    <option value="{{ $value_manager->id }}">{{ $value_manager->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable">{{ __('h_employee.role') }} <span style="color: red;">{{ __('h_employee.required_field') }}</span></label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row" id="passwordField">
                                        <label class="col-sm-2 col-form-lable">{{ __('h_employee.password') }} <span style="color: red;">{{ __('h_employee.required_field') }}</span></label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary float-right">{{ __('h_employee.submit') }}</button>
                                </div>
                            </form>
