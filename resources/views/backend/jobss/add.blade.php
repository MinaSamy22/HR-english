...
@section('content')
                        ...
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" method="post" action="{{ url('admin/jobs/add') }}"
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="submit" id="submitBtn" class="btn btn-primary float-right">{{ __('h_jobs.submit') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        addForm.addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> {{ __('h_jobs.submit') }}...';
        ...
        window.addEventListener('pageshow', function(event) {
            if (event.persisted) {
                ...
                submitBtn.innerHTML = '{{ __('h_jobs.submit') }}';
