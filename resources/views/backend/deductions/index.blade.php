...
@section('content')
    ...
    <div class="content-wrapper" style="background-image: url('{{ asset('/dist/img/deduction.jpg') }}'); background-size: cover; background-position: center;">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <a href="{{ url('admin/deductions/add') }}" class="btn btn-primary rounded-pill">
                        <i class="fas fa-user-plus"></i> Add Deduction
                    </a>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 d-flex align-items-end">
                                            ...
                                            <a href="{{ url('admin/deductions') }}" class="btn btn-success rounded-pill" title="Reset">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" class="deductionCheckbox" value="{{ $value->id }}"></td>
                                            <td>{{ $value->name }}</td>
                                            <td>{{ $value->deduction_type }}</td>
                                            <td>{{ $value->money_deduction }} LE</td>
                                            <td>{{ date('d-m-Y (h:i A)', strtotime($value->created_at)) }}</td>
                                            <td>
                                                <a href="{{ url('admin/deductions/delete/' .$value->id) }}" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger rounded-pill" title="Delete">
