                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-2 col-sm-6">
                                            ...
                                            <input type="text" value="{{ Request()->name }}" name="name"
                                                class="form-control" placeholder="{{ __('h_manager.name') }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3 col-sm-6 d-flex align-items-end">
                                            <button class="btn btn-primary rounded-pill" type="submit"
                                                style="margin-right: 10px;" title="{{ __('h_manager.search') }}">
                                                <i class="fas fa-search"></i>
                                            </button>
                                            <a href="{{ url('admin/manager') }}" class="btn btn-success rounded-pill"
                                                title="{{ __('h_manager.reset') }}">
                                        ...
                                        <tbody>
                                            @forelse ($getRecord as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('admin/manager/view/' . $value->id) }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6" class="text-center">{{ __('h_manager.not_found') }}
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
