...
return [
    ...
    'total_allowance' => 'کل الاؤنسز',
     ...
     // تنخواہ کی توثیق کے پیغامات
    'select_payroll_type' => 'برائے مہربانی تنخواہ کی قسم منتخب کریں۔',
    'daily_exceeds_limit' => 'روزانہ تنخواہ 31 دنوں سے زیادہ نہیں ہو سکتی۔',
    'weekly_exceeds_limit' => 'ہفتہ وار تنخواہ 7 دنوں سے زیادہ نہیں ہو سکتی۔',
    'monthly_minimum_days' => 'ماہانہ تنخواہ 7 دنوں سے زیادہ ہونی چاہیے۔',
    'monthly_exceeds_limit' => 'ماہانہ تنخواہ 31 دنوں سے زیادہ نہیں ہو سکتی۔',
