...
return [
    ...
    'column_list' => 'الكود، الاسم، البريد الإلكتروني، رقم الهاتف، تاريخ الميلاد، تاريخ التوظيف، معرف المسمى الوظيفي، نوع الراتب، الراتب، وقت البداية، وقت النهاية، معرف المدير، معرف القسم، الدور',
